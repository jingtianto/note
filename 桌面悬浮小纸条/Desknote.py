...
class SnippetNote(DragMixin, QLabel):
    ...
    def set_caps(self, lines, chars, height):
...
class SnippetRow(DragMixin, QWidget):
    ...
    def refresh(self):
        ...
        self.note.set_alpha(
            round(self.settings["note_opacity"] * 255 / 100)
        )
...
class SettingsDialog(QDialog):
    ...
    def __init__(self, parent, settings):
        ...
        for spin in (self.spin, self.letter_spin, self.line_spin,
                     self.bar_spin, self.bar_alpha, self.note_alpha,
                     self.offset_spin):
...
class PanelWidget(DragMixin, QWidget):
    ...
    def __init__(self, snippets, settings):
        ...
        self.add_button.setStyleSheet("""
            ...
            QPushButton:disabled { color: #D2D2DA; }
        """)
    ...
    def activate_row(self):
        ...
        if row.action == "run":
            ...
            tip = "✅ 已复制"
        QApplication.instance().show_tooltip(tip)
...
class SnippetApp(QObject):
    ...
    def show_tooltip(self, text="✅ 已复制"):
        ...
        QTimer.singleShot(1200, self.tooltip.hide)
